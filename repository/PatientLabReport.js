const { Patient: patientModel, PatientLabReport: PatientLabReportModel } = require('../database/models');

class Patient {
  static async createPatientLabReport(field = {}, transaction = {}) {
    return PatientLabReportModel.create(field, transaction);
  }
  ...
  */
  static async getPatientLabReport(field = {}, transaction = {}) {
    const { id } = field;
    return PatientLabReportModel.findOne(
      {
        where: {
          id
        },
  ...
  static async getAllLabReportForAPatient(field = {}, transaction = {}) {
    ...
    return PatientLabReportModel.findAll(
      {
        where: {
          patientId
        },
  ...
  static async updatePatientLabReport(field = {}, previous_record = {}, transaction = {}) {
    ...
    return await PatientLabReportModel.update(
      {
        testName,
        isActive,
        testValue,
